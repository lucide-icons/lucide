...
export { default as buildLucideIconForReact } from './build/buildLucideIconForReact';
...
export { default as defaultReactAttributes } from './build/defaultReactAttributes';
