...
public val Lucide.Flower2: ImageVector
    get() {
        if (_flower2 != null) {
            return _flower2!!
        }
        _flower2 = Builder(name = "Flower2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(12.0f, 22.0f)
                curveToRelative(4.2f, 0.0f, 7.0f, -1.667f, 7.0f, -5.0f)
                curveToRelative(-4.2f, 0.0f, -7.0f, 1.667f, -7.0f, 5.0f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
