    ...
    get() {
        ...
        _palette = Builder(name = "Palette", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(0.926f, 0.0f, 1.648f, -0.746f, 1.648f, -1.688f)
                curveToRelative(0.0f, -0.437f, -0.18f, -0.835f, -0.437f, -1.125f)
                curveToRelative(-0.29f, -0.289f, -0.438f, -0.652f, -0.438f, -1.125f)
                arcToRelative(1.64f, 1.64f, 0.0f, false, true, 1.668f, -1.668f)
                horizontalLineToRelative(1.996f)
                curveToRelative(3.051f, 0.0f, 5.555f, -2.503f, 5.555f, -5.554f)
                curveTo(21.965f, 6.012f, 17.461f, 2.0f, 12.0f, 2.0f)
                close()
            }
        }
        .build()
