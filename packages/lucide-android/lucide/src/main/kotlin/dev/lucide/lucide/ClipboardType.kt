...
public val Lucide.ClipboardType: ImageVector
    get() {
        if (_clipboardType != null) {
            return _clipboardType!!
        }
        _clipboardType = Builder(name = "ClipboardType", defaultWidth = 24.0.dp, defaultHeight =
...
private var _clipboardType: ImageVector? = null
