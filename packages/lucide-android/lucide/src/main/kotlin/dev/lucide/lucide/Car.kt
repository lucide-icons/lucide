...
public val Lucide.Car: ImageVector
    get() {
        if (_car != null) {
            return _car!!
        }
        _car = Builder(name = "Car", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(1.0f, 1.0f, 0.0f, false, false, -0.84f, -0.99f)
                lineTo(16.0f, 11.0f)
                ...
                lineToRelative(-0.8f, 1.63f)
                arcTo(6.0f, 6.0f, 0.0f, false, false, 2.0f, 12.42f)
