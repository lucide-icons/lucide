    ...
    get() {
        ...
        _clapperboard = Builder(name = "Clapperboard", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                lineToRelative(-0.88f, -2.87f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, 1.33f, -2.5f)
                lineToRelative(11.48f, -3.5f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, 2.5f, 1.32f)
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveToRelative(6.6f, 4.99f)
                lineToRelative(3.38f, 4.2f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveToRelative(11.86f, 3.38f)
                lineToRelative(3.38f, 4.2f)
            }
        }
        .build()
