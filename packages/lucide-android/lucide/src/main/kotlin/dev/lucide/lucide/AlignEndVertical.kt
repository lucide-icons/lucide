...
public val Lucide.AlignEndVertical: ImageVector
    get() {
        if (_alignEndVertical != null) {
            return _alignEndVertical!!
        }
        _alignEndVertical = Builder(name = "AlignEndVertical", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(4.0f, 4.0f)
                lineTo(16.0f, 4.0f)
                arcTo(2.0f, 2.0f, 0.0f, false, true, 18.0f, 6.0f)
                lineTo(18.0f, 8.0f)
