...
public val Lucide.AlignHorizontalDistributeEnd: ImageVector
    get() {
        if (_alignHorizontalDistributeEnd != null) {
            return _alignHorizontalDistributeEnd!!
        }
        _alignHorizontalDistributeEnd = Builder(name = "AlignHorizontalDistributeEnd", defaultWidth
