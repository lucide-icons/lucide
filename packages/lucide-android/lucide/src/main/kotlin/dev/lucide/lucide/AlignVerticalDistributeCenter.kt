...
public val Lucide.AlignVerticalDistributeCenter: ImageVector
    get() {
        if (_alignVerticalDistributeCenter != null) {
            return _alignVerticalDistributeCenter!!
        }
        _alignVerticalDistributeCenter = Builder(name = "AlignVerticalDistributeCenter",
